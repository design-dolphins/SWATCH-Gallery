        ...
        <div className={`mx-auto flex max-w-[1780px] flex-col px-4 py-4 transition-all duration-300 sm:px-6 lg:px-8 ${showFilters ? "gap-3" : "gap-0"}`}>
          ...
          <div className={`flex flex-wrap items-center gap-2 transition-all duration-300 ${mobileFilterOpen ? "flex max-h-screen opacity-100 overflow-visible" : showFilters ? "hidden lg:flex max-h-screen opacity-100 overflow-visible" : "hidden lg:hidden max-h-0 opacity-0 pointer-events-none overflow-hidden"}`}>
            ...
            <button
              ...
              className={`group flex h-[38px] shrink-0 items-center overflow-hidden rounded-full border pl-[11px] pr-[11px] transition-all duration-200 hover:pr-3 ${compareMode ? "border-acid bg-acid text-white" : "border-black/10 bg-white/60 text-black/40 hover:border-acid/40 hover:bg-acid/10 hover:text-acid"}`}
              aria-label="並べて比較"
            >
              ...
              <span className="ml-0 max-w-0 overflow-hidden whitespace-nowrap text-sm font-bold opacity-0 transition-all duration-200 group-hover:ml-1.5 group-hover:max-w-[80px] group-hover:opacity-100">
                並べて比較
              </span>
            </button>
            <button
              ...
              className={`group flex h-[38px] shrink-0 items-center overflow-hidden rounded-full border pl-[11px] pr-[11px] transition-all duration-200 hover:pr-3 ${showFavoritesOnly ? "border-acid bg-acid text-white" : "border-black/10 bg-white/60 text-black/40 hover:border-acid/40 hover:bg-acid/10 hover:text-acid"}`}
              aria-label="お気に入り"
            >
              <Heart size={15} className={showFavoritesOnly ? "fill-white shrink-0" : "shrink-0"} />
              <span className="ml-0 max-w-0 overflow-hidden whitespace-nowrap text-sm font-bold opacity-0 transition-all duration-200 group-hover:ml-1.5 group-hover:max-w-[72px] group-hover:opacity-100">
                お気に入り
              </span>
            </button>
            {hasActiveFilters && (
