        ...
        <div className={`mx-auto flex max-w-[1780px] flex-col px-4 py-4 transition-all duration-300 sm:px-6 lg:px-8 ${showFilters ? "gap-3" : "gap-0"}`}>
          ...
          <div className={`flex flex-wrap items-center gap-2 transition-all duration-300 ${mobileFilterOpen ? "flex max-h-screen opacity-100 overflow-visible" : showFilters ? "hidden lg:flex max-h-screen opacity-100 overflow-visible" : "hidden lg:hidden max-h-0 opacity-0 pointer-events-none overflow-hidden"}`}>
            ...
            <button
              ...
              className={`group flex h-[38px] shrink-0 items-center overflow-hidden rounded-full border pl-[11px] transition-all duration-200 ${compareMode ? "pr-3" : "pr-[11px] lg:hover:pr-3"} ${compareMode ? "border-acid bg-acid text-white" : "border-black/10 bg-white/60 text-black/40 hover:border-acid/40 hover:bg-acid/10 hover:text-acid"}`}
              aria-label="並べて比較"
            >
              ...
              <span className={`overflow-hidden whitespace-nowrap text-sm font-bold transition-all duration-200 lg:group-hover:ml-1.5 lg:group-hover:max-w-[80px] lg:group-hover:opacity-100 ${compareMode ? "ml-1.5 max-w-[80px] opacity-100" : "ml-0 max-w-0 opacity-0"}`}>
                並べて比較
              </span>
            </button>
            <button
              ...
              className={`group flex h-[38px] shrink-0 items-center overflow-hidden rounded-full border pl-[11px] transition-all duration-200 ${showFavoritesOnly ? "pr-3" : "pr-[11px] lg:hover:pr-3"} ${showFavoritesOnly ? "border-acid bg-acid text-white" : "border-black/10 bg-white/60 text-black/40 hover:border-acid/40 hover:bg-acid/10 hover:text-acid"}`}
              aria-label="お気に入り"
            >
              <Heart size={15} className={showFavoritesOnly ? "fill-white shrink-0" : "shrink-0"} />
              <span className={`overflow-hidden whitespace-nowrap text-sm font-bold transition-all duration-200 lg:group-hover:ml-1.5 lg:group-hover:max-w-[72px] lg:group-hover:opacity-100 ${showFavoritesOnly ? "ml-1.5 max-w-[72px] opacity-100" : "ml-0 max-w-0 opacity-0"}`}>
                お気に入り
              </span>
            </button>
            {hasActiveFilters && (
